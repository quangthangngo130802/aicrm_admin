    ...
    <div class="page-inner">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <a href="{{ route('admin.message.znsMessage') }}" class="card card-stats card-round">
            <div class="card-body">
        ...
        <div class="col-sm-6 col-md-3">
          <a href="{{ route('admin.message.status', ['id' => 0]) }}" class="card card-stats card-round">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-icon">
                  <div
        ...
        <div class="col-sm-6 col-md-3">
          <a href="{{ route('admin.message.status', ['id' => 1]) }}" class="card card-stats card-round">
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col-icon">
                  <div
        ...
        <div class="col-sm-6 col-md-3">
            <a href="{{ route('admin.message.znsTemplate') }}" class="card card-stats card-round">
              <div class="card-body">
                <div class="row align-items-center">
                  <div class="col-icon">
                    <div
